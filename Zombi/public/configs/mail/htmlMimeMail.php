...
class htmlMimeMail
{
    ...
    */
    function htmlMimeMail()
    {
        ...
        */
        ...
        $this->build_params['html_charset']  = 'windows-1250';
        $this->build_params['text_charset']  = 'windows-1250';
        $this->build_params['head_charset']  = 'windows-1250';
    ...
    */
    function setTextCharset($charset = 'windows-1250')
    {
    ...
    */
    function setHtmlCharset($charset = 'windows-1250')
    {
    ...
    */
    function setHeadCharset($charset = 'windows-1250')
    {
    ...
    */
    function _encodeHeader($input, $charset = 'windows-1250')
    {
