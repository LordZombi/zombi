...
class FPDF
{
var $showfooter;         //zobrazenie footru
var $footertext;         //text footru
...
function Footer()
{
  if ( $this->showfooter==true )
  {
		...
		$this->Cell(95, 8, $this->footertext, 'T', false, 'L', 0, '', 0, false, 'T', 'M');
		$this->Cell(95, 8, 'Strana '.$this->PageNo(), 'T', false, 'R', 0, '', 0, false, 'T', 'M');
	}
}
